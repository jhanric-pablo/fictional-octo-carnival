    ...
    <div className="min-h-screen bg-ink text-paper selection:bg-primary/30 overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          className="absolute -top-[10%] -left-[10%] w-[70%] h-[70%] bg-primary/20 blur-[160px] rounded-full"
        />
        <motion.div 
          animate={{ 
            scale: [1.3, 1, 1.3],
          ...
          className="absolute -bottom-[10%] -right-[10%] w-[60%] h-[60%] bg-primary-light/10 blur-[140px] rounded-full"
        />
      ...
      <div className="relative z-10 pt-32 pb-20 px-6 flex flex-col items-center justify-center min-h-screen">
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-serif italic mb-4 tracking-tighter text-primary">
              Operations Center
            </h1>
            <p className="text-white/40 font-light tracking-widest uppercase text-[10px]">
              Authorized command & rescue personnel access
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
              <div className="space-y-6">
                <div className="group/input">
                  <label className="block text-[10px] font-bold uppercase tracking-[0.3em] text-white/30 mb-3 ml-1 group-focus-within/input:text-primary transition-colors">Staff Email</label>
                  <input 
                    type="email" 
                    value={email}
                    ...
                    placeholder="officer@paranaquerescue.gov"
                    required
                  />
                </div>
                <div className="group/input">
                  <label className="block text-[10px] font-bold uppercase tracking-[0.3em] text-white/30 mb-3 ml-1 group-focus-within/input:text-primary transition-colors">Security Password</label>
                  <input 
                    type="password" 
                    value={password}
              ...
              <button 
                type="submit"
                className="w-full py-5 bg-primary text-ink font-black uppercase tracking-[0.2em] text-xs rounded-2xl hover:bg-white hover:text-black transition-all duration-500 flex items-center justify-center gap-3 group/btn shadow-xl cursor-pointer"
              >
